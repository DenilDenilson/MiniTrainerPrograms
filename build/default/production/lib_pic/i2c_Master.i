...
# 2 "<built-in>" 2
# 1 "lib_pic/i2c_Master.c" 2

# 1 "lib_pic/i2c_Master.h" 1
...
# 9 "lib_pic/i2c_Master.h" 2
# 22 "lib_pic/i2c_Master.h"
void I2C_Init(void);
void I2C_Start(void);
...
void I2C_Init(void)
{
    ...
    SSP1ADD = (uint8_t)( ( 8000000UL / ( 4UL * 100000UL ) ) - 1UL);
}
