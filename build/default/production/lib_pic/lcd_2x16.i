...
void Lcd_Cmd(unsigned char a)
{
 ...
 Lcd_Port(a);
 PORTD |= (1<<3);
    _delay((unsigned long)((4)*(8000000UL/4000.0)));
 PORTD &= ~(1<<3);
}
...
void Lcd_Init( void )
{
 ...
 Lcd_Cmd(0x03);
 _delay((unsigned long)((11)*(8000000UL/4000.0)));
 Lcd_Cmd(0x03);
